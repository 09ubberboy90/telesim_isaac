...
class UR_World(TeleopWorld):
    def __init__(self):
        self.urdf_path = "/home/ubb/Documents/Baxter_isaac/ROS2/src/ur_robotiq/ur_robotiq_isaac/urdfs/ur3_robotiq.urdf"
        self.rmp_path = "/home/ubb/Documents/Baxter_isaac/ROS2/src/ur_robotiq/ur_robotiq_isaac/config/ur3_rmp_config.json"
        ...
        self.ros_sub2 = self.create_subscription(
            Pose, "bp/ur/left_hand/pose", self.move_left_cube_unreal_callback, 10
        )
    ...
    def setup_robot_scene(self):
        self.robot_pos = (np.array([0.0, 0, 0]), np.array([1.0, 0.0, 0.0, 0.0]))

        self.robot = self.ros_world.add_robot(
            CortexUR(
                name="ur",
                urdf_path=self.urdf_path,
                rmp_file=self.rmp_path,
